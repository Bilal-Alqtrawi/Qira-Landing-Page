      ...
      <div className="site-shell">
        ...
        <main id="main-content">
            ...
            <div className="container hero-layout">
              <div className="hero-copy">
                <h1>
                  ...
                  <span className="hero-title-accent">
                    في منصة واحدة.
                    <svg viewBox="0 0 460 18" fill="none" aria-hidden="true">
                      <path
                        d="M4 12C118 1 314 0 456 10"
                        stroke="currentColor"
                        strokeWidth="5"
                        strokeLinecap="round"
                      />
                  ...
                  <span className="hero-title-spark" aria-hidden="true">
                    <Icon name="sparkles" size={35} />
                  </span>
                </h1>
                <p className="hero-description">
                  من الطلب الأول وحتى الفاتورة الإلكترونية والتقارير التشغيلية،
                  اجمع عمليات مطعمك في منظومة واحدة تمنح فريقك سرعة أكبر، وإدارة
                  أوضح، وتحكمًا أفضل في كل ما يحدث داخل فرعك.
                </p>
                ...
                <div className="hero-support">
                  ...
                  <p>
                    للفرع الواحد. ولسلسلتك القادمة.
                    <small>منظومة تنمو مع طموحك، خطوة بخطوة.</small>
                  </p>
              ...
              <div className="hero-visual">
                ...
                <div className="hero-dashboard">
                  <DashboardPreview onExplore={() => setModal("tour")} />
                </div>
                <motion.div
                  className="floating-card float-compliance"
                  initial={{ y: 6 }}
                  animate={{ y: 0 }}
                ...
                >
                  ...
                  <div>
                    <b>زاتكا في صميم المنصة</b>
                    <span>فواتيرك منظمة. بالك مرتاح.</span>
                  </div>
                  <span className="float-check">
                    <Icon name="check" size={11} />
                  </span>
                </motion.div>
                <div className="floating-card float-order">
                  <span className="food-thumb">
                    <Image
                      src="/burger.jpg"
                      alt="برجر طازج في طلب المطعم"
                      width={48}
                      height={48}
                    />
                    <i>
                  ...
                  <div>
                    <b>طلب جديد. وصل للمطبخ!</b>
                    <span>
                      طاولة ٠٨ <i />
                      منذ لحظات
                    </span>
                  </div>
                  <span className="order-ping">
                ...
                >
                  <Icon name="qr" size={47} />
                  <span>امسح. اطلب. استمتع.</span>
                  <i>
          ...
          <section
            ...
            style={{ padding: "24px 0", borderRight: "none" }}
          >
            <div
              className="container"
            ...
            >
              ...
              >
                <div className="trust-item" style={{ borderRight: "none" }}>
                  <Icon name="shield" size={29} />
                  <div>
                    <b>بنية مصمّمة وفق متطلبات زاتكا</b>
                    <p>التفعيل الفعلي يتم عند ربط بيانات الاعتماد</p>
                  </div>
                </div>
                <span
                  style={{
                ...
                />
                <div className="trust-item" style={{ borderRight: "none" }}>
                  <Icon name="database" size={29} />
                  <div>
                    <b>بيانات معزولة لكل شركة</b>
                    <p>خصوصيتك جزء من الأساس</p>
                  </div>
                </div>
                <span
                  style={{
                ...
                <div className="trust-item" style={{ borderRight: "none" }}>
                  ...
                  <div>
                    <b>دعم باللغة العربية</b>
                    <p>نفهم يومك، ونتحدث لغتك</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="section problem-section">
            <div className="container problem-layout">
              ...
              <Reveal
                className={`systems-visual ${connected ? "connected" : ""}`}
              >
                <div
                  className="system-tabs"
                  role="group"
                  aria-label="مقارنة التشغيل"
                >
                  <button
                    type="button"
                ...
                <div className="systems-diagram">
                  ...
                  {[
                    { icon: "monitor", name: "نقطة البيع" },
                    { icon: "qr", name: "قائمة الطعام" },
                    { icon: "chef", name: "المطبخ" },
                    { icon: "chart", name: "التقارير" },
                ...
                <div className="systems-bottom">
                  <Icon name={connected ? "link" : "layers"} size={20} />
                  <p>
                    {connected
                      ? "بيانات متصلة. رؤية واحدة. يوم أكثر هدوءًا."
                      : "أنظمة أكثر، لا تعني تحكمًا أفضل."}
                    <span>
                      {connected
                        ? "هذا هو الفرق عندما تعمل الأجزاء معًا."
                        : "حان الوقت لتعمل هذه الأجزاء معًا."}
                    </span>
                  </p>
                  <button
              ...
              >
                {workflow.map((item, i) => (
                  ...
                  >
                    ...
                    {i !== 4 && (
                      <Icon name="left" className="workflow-arrow" size={19} />
                    )}
                  </button>
                ))}
              </div>
              {workflow.map((item, i) => (
                ...
                >
                  ...
                  <div className="workflow-panel-art">
                    ...
                    <div className="flow-art-line" />
                    <span className="flow-art-check">
                      <Icon name="doubleCheck" size={25} />
                    </span>
                  </div>
                </div>
              ))}
          ...
          <section className="section features-section" id="features">
            <div className="container">
              ...
              <div className="feature-grid">
                {features.map((item, i) => (
                  <Reveal key={item.label} delay={(i % 3) * 0.07}>
                    <article className={`feature-card feature-${i}`}>
              ...
              <p className="feature-footnote">
                ...
                ليست أدوات بجانب بعضها. بل منظومة تفهم بعضها.
              </p>
            </div>
          </section>
          ...
          <section className="section roles-section">
            <div className="container">
              <div className="roles-intro">
                ...
                />
                <p>
                  لا يحتاج مدير الشركة إلى رؤية ما يراه الكاشير، ولا يحتاج فريق
                  المطبخ إلى التعامل مع ما يخص الإدارة. واجهات أوضح وصلاحيات
                  مناسبة لكل دور.
                </p>
              </div>
                ...
                >
                  <div className="role-description">
                    ...
                    <span className="role-lock">
                      ...
                      صلاحيات محددة. بيانات محمية.
                    </span>
                  </div>
                  <div className="role-interface">
                    <div className="role-interface-top">
                      <b>
                        <Icon name={roles[role].icon} size={17} />
                        لوحة {roles[role].name}
                      </b>
                      <span className="live-dot" />
                    </div>
                    <div className="role-summary">
                      <span>وضوح في كل التفاصيل</span>
                      <Icon name="sliders" size={14} />
                    </div>
                    {roles[role].permissions.map((permission, i) => (
                      <div className="role-permission-row" key={permission}>
                        <span className={`permission-color color-${i}`}>
                          <Icon
                            name={["chart", "layers", "shield"][i]}
                            size={17}
                          />
                        </span>
                        <div>
                    ...
                    <div className="role-mini-chart">
                      {[42, 65, 51, 77, 60, 89, 75, 100, 87, 115, 99, 129].map(
                        (height, i) => (
                          <motion.span
                            key={i}
                            animate={{ height: height * (role % 2 ? 0.8 : 1) }}
          ...
          <section className="section experience-section" id="experience">
            <div className="container experience-layout">
              <div className="experience-copy">
                <SectionHeading
                  center={false}
                  eyebrow="امنح عميلك تجربة رقمية تليق بمطعمك"
                  title={
                    <>
                      تجربة تُشبه التطبيق.
                      <br />
                ...
                />
                <p>
                  يجلس العميل إلى الطاولة، يمسح رمز QR، ويدخل مباشرة إلى قائمة
                  رقمية مصممة وفق هوية مطعمك. الصور، والأسعار، والتصنيفات،
                  والطلب… كلها في تجربة واضحة وسريعة.
                </p>
                <p className="muted">
                  وإذا سجّل الدخول باستخدام رقم جواله، تصبح تجربته أكثر
                  استمرارية.
                </p>
              ...
              <Reveal className="phone-scene">
                ...
                <div className="phone">
                  ...
                  <div className="phone-table">
                    ...
                    طاولتك ٠٨<span>صُنع بحب. يُقدّم لك.</span>
                  </div>
                  <div className="phone-welcome">
                    <h3>وش تشتهي اليوم؟</h3>
                    <p>أطباق تحبها. وتفاصيل على ذوقك.</p>
                  </div>
                  <div className="phone-categories">
                    <span className="selected" style={{ color: "#ffffff" }}>
                      الأطباق الرئيسية
                    </span>
                    <span>المقبلات</span>
                    <span>المشروبات</span>
                  ...
                  <div className="phone-food">
                    <div className="phone-food-image">
                      <Image
                        src="/burger.jpg"
                    ...
                    <div className="phone-food-copy">
                      <h4>برجر Qira الكلاسيكي</h4>
                      <p>لحم أنجوس، جبن شيدر وصوصنا الخاص.</p>
                      <div>
                        <b>
                          ٤٢ <small>ر.س</small>
                        </b>
                  ...
                  <div className="phone-food-second">
                    <Image
                      src="/salad.jpg"
                      alt="سلطة طازجة"
                      width={59}
                    ...
                    <div>
                      <b>سلطة الحديقة</b>
                      <span>خفيفة. طازجة. وعلى مزاجك.</span>
                      <strong>
                        ٢٨ <small>ر.س</small>
                      </strong>
                    </div>
                ...
                <div className="loyalty-float">
                  ...
                  <div>
                    <b>كل زيارة، لها قيمة.</b>
                    <p>
                      رصيدك <strong>٢٤٠</strong> نقطة ولاء
                    </p>
                  </div>
                  <Icon name="sparkles" size={16} />
                </div>
                <div className="ready-float">
                  <span>
                    <Icon name="chef" size={24} />
                  </span>
                  <div>
                    <b>طلبك صار جاهز!</b>
                    <p>تجربة أسهل. من أول لحظة.</p>
                  </div>
                  <Icon name="check" size={17} />
                </div>
                <span className="phone-scene-caption"></span>
              </Reveal>
            </div>
            <div className="container">
              <div
              ...
              >
                ...
                <div>
                  <h3>
                    أنت لا تبني تجربة أفضل للعميل فقط… بل تبني علاقة تستمر بعد
                    الزيارة.
                  </h3>
                  <p>
                    كلما كانت تجربة العميل أسهل وأكثر سلاسة، أصبحت فرص عودته
                    أكبر.
                  </p>
                </div>
              ...
              <div className="compliance-block">
                <div className="compliance-copy">
                  <span className="dark-badge">
                    ...
                    مصممة مع وضع متطلبات زاتكا في صميمها
                  </span>
                  <h2>
                    الامتثال ليس إضافة.
                    <br />
                    <span>بل نقطة البداية.</span>
                  </h2>
                  <p>
                    الامتثال ليس طبقة أُضيفت لاحقًا… بل جزء من أساس المنصة.
                    عندما تكون الفاتورة جزءًا أساسيًا من عمليات مطعمك، فإن
                    الامتثال لا ينبغي أن يكون مهمة منفصلة أو مصدر قلق إضافي.
                  </p>
                  <div className="compliance-seal">
                    <Icon name="shield" size={49} />
                    <div>
                      <b>حماية وتنظيم</b>
                      <span>على مستوى دورة الفاتورة</span>
                    </div>
                  </div>
                  <small>
                    يتطلب الإرسال الفعلي تفعيل إضافة زاتكا وربط بيانات الاعتماد.
                    البروتوتايب لا يصدر فواتير ضريبية فعلية.
                  </small>
                </div>
                ...
                <div className="compliance-bottom">
                  <span>أنت تدير مطعمك.</span>دع Qira تهتم بتفاصيل التشغيل.
            ...
            <div className="container">
              ...
              <div className="pricing-layout">
                ...
                >
                  ...
                  <p>كل ما تحتاج إليه لتبدأ التشغيل</p>
                  <div className="core-plan-price">
                    <strong>على قد احتياجك.</strong>
                    <span>عرض مخصص يناسب مطعمك، لا العكس.</span>
                  </div>
                  <ul>
                ...
                <div className="addons-panel">
                  <div className="addons-heading">
                    <div>
                      <span className="eyebrow">
                        أنت تختار. ونحن نجمعها لك.
                      </span>
                      <h3>صمم باقتك بكل مرونة حسب احتياجك</h3>
                    </div>
                    <span className="addons-hint">
                  ...
                  <div className="addons-list">
                    {addOns.map((item) => (
                      <button
                        key={item.name}
                        type="button"
                        aria-pressed={selectedAddOns.includes(item.name)}
                        className={`addon-row ${selectedAddOns.includes(item.name) ? "selected" : ""}`}
                  ...
                  <div className="quote-summary">
                    <div>
                      <span>منظومتك، على طريقتك</span>
                      <b aria-live="polite">
                        النظام الأساسي
                        {selectedAddOns.length > 0
                          ? ` + ${selectedAddOns.length.toLocaleString("ar-SA")} إضافات`
                          : " فقط"}
                      </b>
                    </div>
                    <button
              ...
              <div className="pricing-fit">
                <div>
                  ...
                  <span>
                    <b>للفرع الواحد</b>
                    <p>ابدأ بالأساسيات، وأضف فقط ما تحتاج إليه.</p>
                  </span>
                </div>
                <span className="fit-divider" />
                <div>
                  <Icon name="building" size={27} />
                  <span>
                    <b>للسلاسل متعددة الفروع</b>
                    <p>وسّع إمكاناتك تدريجيًا مع نمو نشاطك، فرعًا بعد فرع.</p>
                  </span>
                </div>
              </div>
              <p className="pricing-ending">
                أنت تختار ما تحتاج إليه. <b>ونحن نوفر لك المساحة لتنمو.</b>
              </p>
            </div>
          </section>
            ...
            <div className="container faq-layout">
              <div className="faq-intro">
                <SectionHeading
                  ...
                  description="إجابات واضحة لأسئلتك. لأن البداية الأفضل تبدأ من الاطمئنان."
                />
                <div className="faq-support">
                  ...
                  <div>
                    <b>لم تجد إجابة لسؤالك؟</b>
                    <button
                      type="button"
                      className="text-button"
                      onClick={contactFocus}
                    >
          ...
          <section className="section final-section">
            <div className="container final-layout">
              <div className="final-copy">
                <span className="eyebrow">
                  <span />
                  أقل انشغالًا بالتفاصيل. أكثر تركيزًا على الشغف.
                </span>
                <h2>
                  هل أنت مستعد لترى الفرق
                  <br />
                  داخل مطعمك؟
                </h2>
                <p>
                ...
                <button
                  type="button"
                  className="final-secondary text-button"
                  onClick={() => setModal("demo")}
                >
                  <Icon name="calendar" size={17} />
                  احجز عرضًا تجريبيًا مباشرًا مع فريقنا
                  <Icon name="arrow" size={16} />
                </button>
                <p className="final-microcopy">
                  دون بطاقة ائتمانية · دون التزام · ابدأ خلال دقائق
                </p>
              </div>
              <Reveal className="kitchen-story">
                <Image
                  src="/kitchen.jpg"
                  alt="فريق مطعم يعمل بتناغم في مطبخ حديث"
                  width={600}
                  height={450}
                  loading="lazy"
                />
                <div className="kitchen-overlay">
                  <span>اترك التعقيد خلفك.</span>
                  <h3>
                    وتفرّغ لما
                    <br />
                    تحب أن تقدّمه.
                ...
                <div className="kitchen-story-badge">
                  <Icon name="heart" size={18} />
                  للمطاعم التي تُدار بشغف.
                </div>
              </Reveal>
            </div>
          </section>
            ...
            <div className="container contact-layout">
              <div className="contact-copy">
                <SectionHeading
                  ...
                  title={
                    <>
                      لديك سؤال
                      <br />
                      <span className="coral-text">قبل أن تبدأ؟</span>
                    </>
                  }
                />
                <h3>دعنا نساعدك في معرفة ما يناسب مطعمك.</h3>
                <p>
                  سواء كنت تدير فرعًا واحدًا أو سلسلة من الفروع، يمكن لفريقنا
                  فهم احتياجاتك واستعراض الطريقة التي يمكن أن تتناسب بها المنصة
                  مع طبيعة عملياتك.
                </p>
                <div className="contact-methods">
                  <a
                    href={site.email ? `mailto:${site.email}` : "#contact"}
                    onClick={site.email ? undefined : contactFocus}
                  >
                    <span>
                    ...
                    <div>
                      ...
                      <b>{site.email || "راسل فريق Qira"}</b>
                    </div>
                    <Icon name="arrowUp" size={17} />
                  </a>
                  <button type="button" onClick={() => setModal("whatsapp")}>
                    <span>
                      <Icon name="message" size={23} />
                    </span>
                    <div>
                      <small>واتساب — تواصل مباشر</small>
                      <b>خلّنا نتحدث عن مطعمك</b>
                    </div>
                    <Icon name="arrowUp" size={17} />
                  </button>
                ...
                <div className="contact-assurance">
                  ...
                  <p>
                    بياناتك في أمان.
                    <span>
                      سيتواصل معك فريقنا خلال ساعات العمل. لا نشارك بياناتك مع
                      أي جهة أخرى.
                    </span>
                  </p>
                </div>
              ...
              <Reveal className="contact-card">
                <div className="contact-card-title">
                  <h3>خلّنا نتعرف على مطعمك.</h3>
                  <p>خطوة بسيطة، وبداية لمنظومة تناسبك.</p>
                </div>
                <ContactForm />
              </Reveal>
            </div>
          ...
          <div className="container">
            <div className="footer-top">
              <div className="footer-about">
                ...
                />
                <p>
                  منصة سحابية متكاملة لإدارة عمليات المطاعم، من الطلب والتحصيل
                  وحتى الفوترة والتقارير. صُممت لتناسب الفرع الواحد وسلاسل
                  المطاعم متعددة الفروع.
                </p>
                <span className="footer-tagline"></span>
              </div>
              <div className="footer-links">
                <h3>روابط سريعة</h3>
                {navLinks
                  .filter(([, id]) => !["how-it-works", "contact"].includes(id))
                  .map(([name, id]) => (
                    <a href={`#${id}`} key={id}>
                      {name}
                    </a>
              ...
              <div className="footer-links">
                ...
                <Link href="/legal/retention">سياسة الاحتفاظ بالبيانات</Link>
              </div>
              <div className="footer-links footer-contact">
                <h3>لنبنِ بداية أفضل</h3>
                <button onClick={contactFocus} type="button">
            ...
            <div className="footer-trust">
              <span>
                <Icon name="shield" size={16} />
                مصممة لمتطلبات زاتكا
              </span>
              <span>
                <Icon name="lock" size={16} />
                ممارسات أمان تراعي PDPL
              </span>
              <span>
        ...
        >
          ...
          <span className="fab-tooltip">تواصل معنا عبر واتساب</span>
          <i />
        </a>
        ...
        <AnimatePresence>
          {modal && (
            <Modal
              ...
              title={
                modal === "trial"
                  ? "مطعمك الجديد، يبدأ من هنا."
                  : modal === "login"
                    ? "أهلًا بعودتك إلى Qira"
                    : modal === "tour"
                      ? "دقيقة واحدة. صورة كاملة."
                      : modal === "demo"
                        ? "لنستكشف Qira معًا"
                        : modal === "quote"
                          ? "منظومة على مقاس مطعمك"
                          : modal === "whatsapp"
                            ? "تواصل معنا عبر واتساب"
                            : features[feature].label
              }
            >
              {(modal === "trial" || modal === "login") && (
                <AuthForm
                  key={modal}
                  mode={modal}
                  onModeChange={setModal}
                  onContact={() => setModal("demo")}
                />
              )}
              {modal === "tour" && (
                <div className="tour-content">
                  <p>
                    جولة تفاعلية ببيانات توضيحية. جرّب تبديل الفترة والفرع، أو
                    افتح شاشة المطبخ من القائمة الجانبية.
                  </p>
                  <DashboardPreview expanded />
                  <div className="tour-step">
                    <span className="icon-tile">
                      <Icon name={workflow[tourStep].icon} size={25} />
                    </span>
                    <div>
                      <small>الخطوة {tourStep + 1} من ٥</small>
                      <h3>{workflow[tourStep].title}</h3>
                      <p>{workflow[tourStep].description}</p>
                    </div>
                  </div>
                    ...
                    <div className="tour-dots">
                      {workflow.map((item, i) => (
                        <button
                          ...
                          type="button"
                          className={tourStep === i ? "active" : ""}
                          aria-label={`الخطوة ${i + 1}: ${item.title}`}
                        />
                      ))}
                    </div>
                    {tourStep < 4 ? (
              ...
              {(modal === "demo" ||
                ...
                modal === "whatsapp") && (
                <>
                  {modal === "whatsapp" && site.whatsapp && (
                    <a
                      className="button button-teal full-width whatsapp-direct"
...
function FeatureArt({ index }: { index: number }) {
  return (
    <div className={`feature-art art-${index}`} aria-hidden="true">
      {index === 0 && (
        <>
          <div className="art-qr">
            <Icon name="qr" size={53} />
            <span>طاولة ٠٨</span>
          </div>
          <div className="art-order">
            <span className="art-order-icon">
              <Icon name="bag" size={16} />
            </span>
            <div>
              <b>طلب جديد</b>
              <span>تم الإرسال إلى المطبخ</span>
            </div>
      ...
      {index === 1 && (
        <div className="art-kds">
          {["جديد", "قيد التحضير", "جاهز"].map((label, i) => (
            <div key={label}>
              <span>
                <i />
                {label}
              </span>
              <div className="art-kds-ticket">
                <b>#٠٤{i + 6}</b>
                <i />
                <i />
                <span>
                  <Icon name="clock" size={9} />٠{i + 2}:٣٠
                </span>
              </div>
            </div>
          ))}
      ...
      {index === 2 && (
        <>
          <div className="art-pos">
            <span>
              إجمالي الفاتورة
              <Icon name="receipt" size={15} />
            </span>
            <b>
              ٨٤.٠٠ <small>ر.س</small>
            </b>
            <div>
              <span>
          ...
          <span className="art-payment-success">
            <Icon name="doubleCheck" size={15} />
            تم الدفع بنجاح
          </span>
        </>
      )}
        ...
        <div className="art-shift">
          ...
          <div className="shift-amounts">
            ...
            <span>
              الرصيد الحالي
              <b>
                ٢٬٤٥٠ <small>ر.س</small>
              </b>
            </span>
          </div>
          <span className="shift-progress">
            <i />
          </span>
          <span className="shift-balanced">
            <Icon name="check" size={12} />
            كل ريال، في مكانه الصحيح.
          </span>
        </div>
      )}
      {index === 4 && (
        <>
          <div className="art-invoice">
            <span>
              <Icon name="receipt" size={18} />
              <b>فاتورة إلكترونية</b>
              <small>#٠٠١٤٨</small>
            </span>
            <div>
              <i />
            ...
            <span className="invoice-xml">
              UBL 2.1 <Icon name="lock" size={10} />
            </span>
          </div>
          <span className="art-zatca">
            <Icon name="shield" size={24} />
            <b>مصمّمة لمتطلبات زاتكا</b>
          </span>
        </>
      )}
      {index === 5 && (
        <>
          <div className="art-loyalty">
            <span>
              <Icon name="gift" size={21} />
              مكافأة كل زيارة
            </span>
            <b>
              ٢٤٠ <small>نقطة</small>
            </b>
            <div>
              {[1, 2, 3, 4, 5].map((n) => (
                <span key={n}>
                  <Icon name={n === 5 ? "gift" : "check"} size={11} />
                </span>
              ))}
            </div>
          </div>
          <span className="art-growth">
            <Icon name="trend" size={19} />
            <span>
              علاقة تدوم<small>بعد الزيارة الأولى</small>
            </span>
          </span>
        </>
      )}
